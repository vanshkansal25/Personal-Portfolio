...
// import { Timeline } from "./Timeline"; // adjust path if needed
...
//             It all began with curiosity — the urge to understand how websites
//             work. I started experimenting with HTML and CSS, making static
...
//             <img
//               src="https://images.unsplash.com/photo-1581091012184-e0d23cbdf9e3?auto=format&fit=crop&w=800&q=80"
//               alt="Origin"
...
//         <div>
//           <p className="text-neutral-300 text-sm md:text-base font-normal mb-8">
//             Every hero's journey has trials — mine was debugging at 2 AM,
//             questioning my path, and learning from countless resources. From
...
//         <div>
//           <p className="text-neutral-300 text-sm md:text-base font-normal mb-8">
//             With projects, internships, and real-world problems, my skills grew
//             exponentially. I learned to write cleaner code, collaborate in
//             teams, and build impactful features. The more I created, the more
//             confident I became in my craft and problem-solving abilities.
//           </p>
//           <div className="grid grid-cols-2 gap-4">
//             <img
...
//         <div>
//           <p className="text-neutral-300 text-sm md:text-base font-normal mb-8">
//             Today, I’m focused on mastering full-stack development and building
//             projects that solve real problems. I continue to share my learnings
//             in public, collaborate with like-minded devs, and aim to craft
//             tools that empower others. This chapter is still being written —
//             one line of code at a time.
//           </p>
//           <div className="grid grid-cols-2 gap-4">
//             <img
//               src="https://images.unsplash.com/photo-1580894908361-9671950330ec?auto=format&fit=crop&w=800&q=80"
//               alt="Now"
//               className="rounded-lg object-cover h-28 md:h-44 lg:h-60 w-full shadow-md"
//             />
//             <img
//               src="https://images.unsplash.com/photo-1581093457585-8403e3d54b43?auto=format&fit=crop&w=800&q=80"
//               alt="Building"
//               className="rounded-lg object-cover h-28 md:h-44 lg:h-60 w-full shadow-md"
//             />
//           </div>
