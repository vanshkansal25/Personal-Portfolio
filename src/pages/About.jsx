...
//                 className="text-5xl inline-block mr-2 wave-hand"
//               >
//                 👋
//               </span>
...
//               </h1>
//               <p className="text-lg text-black leading-relaxed font-[Typo-6]">
//                 I’m a self-taught developer with a passion for turning ideas into
//                 interactive experiences. From building my first webpage at midnight
//                 to exploring the world of full-stack development, my journey is fueled
//                 by curiosity and creativity. I love crafting intuitive designs,
//                 writing clean code, and constantly evolving with the tech landscape.
//                 This space is my story — built one commit at a time.
//               </p>
//             </div>
...
//                 src={myphoto2}
//                 alt="Vansh Kansal"
//                 className="rounded-2xl object-cover w-full max-w-[400px] h-auto shadow-md"
//               />
//             </div>
//           </div>
//         </div>
...
//       {/* Armory Section */}
//       <div className="bg-black py-16 text-white text-center px-6 md:px-20">
//         <h2 className="text-4xl font-bold mb-4">Armory</h2>
//         <p className="text-lg max-w-3xl mx-auto font-light">
//           These are the tools and technologies I've forged through projects, practice, and persistence.
//           Every framework, language, and concept is another arrow in my quiver — ready to be drawn when
//           challenges strike.
//         </p>
//       </div>
...
//       {/* Subtagline / Continuation */}
//       <div className="bg-black text-white text-center py-10 px-6">
//         <p className="max-w-3xl mx-auto text-base md:text-lg font-light">
//           As I continue to sharpen my craft, I explore new realms in tech — expanding this armory with
//           curiosity and clarity, preparing for battles yet to come.
//         </p>
//       </div>
